class SceneMain extends Phaser.Scene {
    ...
    create() {
        ...
        this.evil = this.add.image(300,400, "evil").setOrigin(0,0);//(this.game.height*.30, this.game.width*.70, "evil").setOrigin(0,0);
        this.evil.depth=10000;
        this.evil.setAlpha(.4);
        this.nice = this.add.image(500,400, "nice").setOrigin(0,0);//(this.game.height*.30, this.game.width*.80, "nice").setOrigin(0,0);
        ...
        this.newGame.on("pointerdown", ()=>{
            this.scene.start("SceneMainMenu",{extremeMode:true});
        }, this);
